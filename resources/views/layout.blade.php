                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php
                                    ...
                                    $shpping_id = Session::get('shpping_id');
                                ?>
                                @if($customer_id != NULL && $shpping_id == NULL)
                                    <li><a href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @elseif($customer_id != NULL && $shpping_id != NULL)
                                ...
                                @if($customer_id != NULL)
                                    <li><a href="{{URL::to('/shipping-logout')}}"><i class="fa fa-lock"></i> Logout</a></li>
                                @else
                         ...
                         @foreach($all_category as $item)
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/product-by-category/'.$item->category_id)}}">{{$item->category_name}}</a></h4>
                                </div>
                            </div>
                         @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{URL::to('/product-by-brand/'.$item->brand_id)}}"> <span class="pull-right">(50)</span>{{$item->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
